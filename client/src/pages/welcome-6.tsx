        ...
        <div className="w-full max-w-md flex flex-col items-center space-y-12">
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-3 -right-3 w-14 h-14 bg-gradient-to-br from-cyan-400 to-cyan-500 rounded-2xl flex items-center justify-center shadow-xl transform -rotate-12">
